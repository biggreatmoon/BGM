...
large_buttons = {
    ...
    "나를 표현한 음악": "Deadline.mp3"  # 이 경로를 실제 음악 파일로 변경하세요.
}

small_buttons = {
    "나의 장점": "무언가에 관심이 생긴다면 그 문제를 해결하는 것을 좋아합니다.",
    "희망 진로": "AI개발자나 프로그래머와같은 소프트웨어 쪽의 직업을 가지고 싶다.",
    "좋아하는 것": "음악감상, 독서, 게임, 정보찾아보기를 좋아합니다.",
    "싫어하는 것": "궁금한 점을 해결하지 못하는 것을 싫어 해요.",
    "자기 소개": "음악을 감상하면서 게임을 하는 것을 좋아하는 학생",
    "진로 준비": "종합으로 대학을 가기 위해서 열심히 생기부를 채우는 중.",
    "취미 활동": "음악감상, 게임, 궁금한 정보 찾아보기, 신규정보 찾아보기.",
    "성공 사례": "최근에 사이트를 하나 만들어 학업관련 정보를 배포하고 추가적으로 실시간 채팅, 게시판을 개발중"
}
...
if st.session_state.active_button == "나를 표현한 음악":
    st.audio("Deadline.mp3", format="audio/mp3")
